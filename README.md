...
<div class="topbar">
  ...
  <div class="menu">
    <div class="menu-item" onclick="showPage('listPage')">列車一覧</div>
    <div class="menu-item" onclick="showPage('detailPage')">列車詳細</div>
    <div class="menu-item" onclick="showPage('timetablePage')">各駅時刻表</div>
    <div class="menu-item" onclick="showPage('monitorPage')">モニター</div>
    <div class="menu-item" onclick="showPage('settingPage')">設定</div>
  </div>
...
<div id="detailPage" class="page">
  ...
  <div id="adminButtons" style="display:none;">
    ...
    <button onclick="deleteSelectedTrain()">削除（管理者のみ）</button>
  </div>
</div>
...
<div id="timetablePage" class="page">
  ...
  <div style="margin-bottom:8px;">
    方向：
    <label><input type="radio" name="ttDirection" value="up" checked onchange="renderTimetable()"> 上り</label>
    <label style="margin-left:10px;"><input type="radio" name="ttDirection" value="down" onchange="renderTimetable()"> 下り</label>
  </div>
  <div>
    駅名:
    <select id="stationSelect" onchange="renderTimetable()"></select>
    または 駅名入力:
    <input id="stationInput" placeholder="例: 調布">
    <button onclick="renderTimetableFromInput()">表示</button>
  </div>
...
<div id="monitorPage" class="page">
  ...
  <div style="margin-bottom:8px;">
    ...
    <label style="margin-left:10px;"><input type="radio" name="monDirection" value="down" onchange="renderMonitorAll()"> 下り</label>
  </div>
  <div id="monitorWrapper">
    <div id="monitorRoute"></div>
    <div id="monitorTrains"></div>
  </div>
</div>
...
const API_URL =
  "https://script.google.com/macros/s/AKfycbz0tdgu-dEoc8Zrhg0waJ06MsiLSf_zYFkx_zQ-mf8ViosQCyQuklVmLlGOZCmA78sT/exec";
